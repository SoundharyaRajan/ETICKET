...
<center><br>
<b><h1><font color="#ff0066">ADD AIRLINE DETAILS</font></h1></b>
<div class="input-container">
<i class="fa fa-user icon"></i>
<input class="input-field" type="text" placeholder="Airline ID" name="aid" required>
</div>
<div class="input-container">
<i class="fa fa-user icon"></i>
<input class="input-field" type="text" placeholder="Airline Type" name="atype" required>
</div>
<div class="input-container">
...
if(isset($_POST['new']) && $_POST['new']==1){
    ...
    $fare = $_REQUEST['fare'];
    $ins_query="insert into airline
    (`AIRLINEID`,`AIRLINETYPE`,`STARTPLACE`,`ENDPLACE`,`STARTTIME`,`ENDTIME`,`MAXSEATS`,`AVAILSEATS`,`FARE`) values
    ('$aid','$atype','$splace','$aplace','$stime','$atime','$mseats','$aseats','$fare')";
if(mysqli_query($con,$ins_query))
{
?>   
<script language="javascript">
alert("NEW AIRLINE ADDED SUCCESFULLY");
window.location.href="airdetail.php"
</script>
<?php
} 
else{
...
window.location.href="addairline.php"
</script>
<?php   
}
}
