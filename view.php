...
include "main.php";
$ID=$_REQUEST['BUSID'];
$namesql = "SELECT * FROM bus WHERE BUSID='".$ID."'";
...
<tr>
<th> <h3><font color="green">ONLINE BUS TICKET</font> </h3></th>
</tr>
</thead>
...
<tr>
<h4><td><b>BUS ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp; <?php echo $row["BUSID"];?></td></h4>
</tr>
<tr>
<h4>  <td><b>BUS TYPE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp; <?php echo $row["BUSTYPE"]; ?></td></h4>
</tr>
<tr>
...
<div align="center">Print Your Bus Ticket</div>
</button></center>
<script>
function myFunction() {
window.print();
