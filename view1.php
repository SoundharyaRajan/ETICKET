...
<thead class="table table-bordered " >
      <tr>
      <th> <h3><font color="green">ONLINE AIRLINE TICKET</font> </h3></th>
      </tr>
      </thead>
      ...
      <tr>
      <h4>  <td><b>AIRLINE ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp; <?php echo $row["AIRLINEID"] ;?></td></h4>
      </tr>
      <tr>
      <h4>  <td><b>AIRLINE TYPE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp; <?php echo $row["AIRLINETYPE"] ;?></td></h4>
      </tr>
      <tr>
...
<div align="center">Print Your Airline Ticket</div>
</button></center>
<script>
function myFunction() {
window.print();
