...
if ($splace != "" && $dplace != "")
{
$sql_query = "select count(*) as cntUser from train where STARTPLACE='".$splace."' and ENDPLACE='".$dplace."'";		
...
if($count > 0)
{
$namesql = "SELECT * FROM train WHERE STARTPLACE = '".$splace."' and ENDPLACE='".$dplace."'";
...
header("Location: trainavailablee.php");
}
else{
?>
<script language="javascript">
alert("NO TRAINS ARE AVILABLE");
