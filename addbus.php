...
<center><br>
<b><h1><font color="#ff0066">ADD BUS DETAILS</font></h1></b>
<div class="input-container">
<i class="fa fa-user icon"></i>
<input class="input-field" type="text" placeholder="Bus ID" name="bid" required>
</div>
<div class="input-container">
...
if(isset($_POST['new']) && $_POST['new']==1){   
    ...
    $fare = $_REQUEST['fare'];
    $ins_query="insert into bus
    (`BUSID`,`STARTPLACE`,`ENDPLACE`,`STARTTIME`,`ENDTIME`,`MAXSEATS`,`AVAILSEATS`,`FARE`)values
    ('$bid','$splace','$aplace','$stime','$atime','$mseats','$aseats','$fare')";
if(mysqli_query($con,$ins_query))
{
?>   
<script language="javascript">
alert("NEW BUS ADDED SUCCESFULLY");
window.location.href="busdetail.php"
</script>
<?php
} 
else{
