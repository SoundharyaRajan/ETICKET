...
if ($splace != "" && $dplace != "")
{
$sql_query = "select count(*) as cntUser from bus where STARTPLACE='".$splace."' and ENDPLACE='".$dplace."'";		
...
if($count > 0)
{
$namesql = "SELECT * FROM bus WHERE STARTPLACE = '".$splace."' and ENDPLACE='".$dplace."'";
...
header("Location: busavailablee.php");
}
else{
?>
<script language="javascript">
alert("NO BUSES ARE AVILABLE");
